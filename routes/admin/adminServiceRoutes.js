...
import { createService ,updateService,deleteService,toggleServiceStatus, getAllServices} from "../../controller/admin/adminServiceController.js";
import { protectAdmin } from "../../middleware/adminauthMiddleware.js";

const router = express.Router();
router.get("/",protectAdmin,getAllServices)
router.get("/:id",protectAdmin,getAllServices)
